...
class MNTopo(Topo):
    ...
    def __init__(self, cpu=.1, max_queue_size=None, **params):
        ...
        s2 = self.addSwitch('s2') # Added by Tao
        s3 = self.addSwitch('s3') # Added by Tao
	...
	sender = self.addHost('sender', **hostConfig)
        ...
        # Wire s1-s2
        self.addLink(s1, s2, port1=3, port2=4, **linkConfig) # Added by Tao

        # Wire s2-s3
        self.addLink(s2, s3, port1=3, port2=4, **linkConfig) # Added by Tao
